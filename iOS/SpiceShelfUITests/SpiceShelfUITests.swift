...
final class SpiceShelfUITests: XCTestCase {
    ...
    func testAddFlow() {
        ...
        nameField.tap()
        nameField.typeText("UI Test Spice")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["UI Test Spice"].waitForExistence(timeout: 2))
    }
